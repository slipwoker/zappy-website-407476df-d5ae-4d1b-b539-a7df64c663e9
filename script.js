    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Bamboo Heaven uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '407476df-d5ae-4d1b-b539-a7df64c663e9',
                    name: data.name || '',
                    email: data.email || '',
